...
const editor_wikimarkup_transformer_1 = require("@atlaskit/editor-wikimarkup-transformer");
...
class JiraTicketProvider {
    ...
    async generateTicketContent(errorGroup) {
        ...
        const wikiTransformer = new editor_wikimarkup_transformer_1.WikiMarkupTransformer();
    ...
    static compareTicketContent(existingTicketContent, freshTicketContent) {
        const adfTransformer = new editor_json_transformer_1.JSONTransformer();
        const wikiTransformer = new editor_wikimarkup_transformer_1.WikiMarkupTransformer();
        ...
        console.log('existingDescription: ', existingDescription);
        console.log('freshDescription: ', freshDescription);
