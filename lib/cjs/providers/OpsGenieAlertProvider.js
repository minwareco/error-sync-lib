...
class OpsGenieAlertProvider {
    ...
    async findAlert(clientId) {
        ...
        if (!opsgenieAlert) {
            ...
            return {
                ...
                labels: (_a = opsgenieAlert.tags) !== null && _a !== void 0 ? _a : [],
    ...
    async generateAlertContent(errorGroup) {
        ...
        return {
            ...
            labels: (_b = (_a = errorGroup.instances[0]) === null || _a === void 0 ? void 0 : _a.labels) !== null && _b !== void 0 ? _b : [],
            ticketUrl: (_c = errorGroup.ticket) === null || _c === void 0 ? void 0 : _c.url,
            status: 'open',
        };
    }
}
