        ...
        for (let i = 0; i < errorGroups.length; ++i) {
            ...
            if (newErrorGroup.name === existingErrorGroup.name) {
                ...
                existingErrorGroup.mixpanelIds = Array
                    .from(new Set([...existingErrorGroup.mixpanelIds, ...((_a = error.mixpanelIds) !== null && _a !== void 0 ? _a : [])]));
                existingErrorGroup.userEmails = Array
                    .from(new Set([...existingErrorGroup.userEmails, ...((_b = error.userEmails) !== null && _b !== void 0 ? _b : [])]));
                return;
            }
        }
