...
export class NewRelicErrorProvider {
    constructor(config) {
        this.config = config;
    }
    ...
    getErrors() {
        return __awaiter(this, arguments, void 0, function* (hoursBack = 24, limit = 1000) {
