import { OpsGenieAlertProvider } from '../../providers/OpsGenieAlertProvider';
import { ErrorPriority, ErrorType, ErrorCountType } from '../../models';
...
describe('OpsGenieAlertProvider', () => {
    ...
    let provider;
    const mockCreate = opsGenie.alertV2.create;
    const mockGet = opsGenie.alertV2.get;
    beforeEach(() => {
        jest.clearAllMocks();
