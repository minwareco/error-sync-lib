...
export class Synchronizer {
    ...
    syncErrorGroup(errorGroup, errorConfig) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.config.cacheProvider.setObject(errorGroup.clientId, errorGroup.ticket, CacheName.Tickets, false);
            if (!errorGroup.alert) {
            ...
            if (shouldIgnore || !errorGroup.ticket.isOpen) {
                ...
                yield this.config.alertProvider.updateAlert(errorGroup.alert);
            }
            yield this.config.cacheProvider.setObject(errorGroup.clientId, errorGroup.alert, CacheName.Alerts, false);
        });
    }
